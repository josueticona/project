                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/productos/update" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="descripcion" name="descripcion" value=<?php echo $producto->nombre?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="categoria" id="categoria" class="form-control">
                                    <?php foreach($categorias as $categoria):?>
                                        <?php if($categoria->idcategorias == $producto->categoria_id):?>
                                        <option value="<?php echo $categoria->idcategorias?>" selected><?php echo $categoria->nombre;?></option>
                                    <?php else:?>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-success btn-flat">GUARADR</button>
                            </div>
                        </form>
                    </div>
                </div>
