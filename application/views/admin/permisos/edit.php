            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php endif;?>
                        ...
                        <input type="hidden" name="idpermiso" value="<?php echo $permiso->idPermisos?>">

                            <div class="form-group">
                                <label for="rol">Roles</label>
                            <select name="rol" id="rol" class="form-control" disabled="disabled">
                                <?php foreach($roles as $rol):?>
                                    <option value="<?php echo $rol->idroles;?>"<?php echo $rol->idroles == $permiso->ro_id ? "selected":"";?>><?php echo $rol->nombre;?></option>
                                <?php endforeach;?>
                            </select>
                           ...
                           <select name="menu" id="menu" class="form-control" disabled="disabled">
                               <?php foreach($menus as $menu):?>
                                <option value="<?php echo $menu->idMenus;?>" <?php echo $menu->idMenus == $permiso->menu_id ? "selected":"";?>><?php echo $menu->nombre;?>
                                </option>
                            <<?php endforeach; ?>
                           </select>
                        </div>
